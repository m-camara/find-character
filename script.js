...
const personnages = [
    ...
    {nom: "Elie", image : "images/Elie.webp",jeux: "The Last Of Us Part II"},
    
    {nom: "Jett", image : "images/jett.webp",jeux: "Valorant"},

    {nom: "Ayane", image : "images/ayane.webp",jeux: "Dead or Alive"},

    {nom: "Abby", image : "images/abby.webp",jeux: "The Last Of Us Part II"},
...
function trouvePersonnages(){
    ...
    if(guess.toLowerCase() === personnagesRandom.nom.toLowerCase()){
        ...
        titreJeu.textContent = `Jeu : ${personnagesRandom.jeux}`;
        titreJeu.color = "white";
